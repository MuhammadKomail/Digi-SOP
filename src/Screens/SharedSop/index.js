            ...
            <SafeArea>
                <View style={{ flex: 1, width: '100%', height: '100%', backgroundColor: 'pink' }}>
                    <ImageBackground
                        ...
                        <View style={{ backgroundColor: '#EFF1FD', marginTop: 40, borderTopRightRadius: 50, borderTopLeftRadius: 50, paddingTop: 15, marginBottom: 110 }}>
                            <ScrollView>
                                    ...
                                    <View>
                                        <View style={{ flexDirection: 'row', justifyContent: 'center' }}>
                                            <View style={{ marginVertical: '5%' }}>
                                                <Text style={{ fontSize: 14 }}>Shared With You</Text>
                                                <Text style={{ fontSize: 10 }}>Shared Digital SOP Guide</Text>
                                            </View>
                                        </View>
                                        <View style={{ flexDirection: 'row', flex: 1, flexWrap: 'wrap' }}>
                                            <View style={{ borderRadius: 10, width: '45%', margin: '2%' }}>
                                                <Image
